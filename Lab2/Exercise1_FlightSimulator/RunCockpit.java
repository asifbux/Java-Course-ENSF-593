...
public class RunCockpit {
	...
	public static void main(String [] args)
	{
		...
		System.out.println("From: " + String.format("%s (%.0f , %.0f)", sourceAirport.getLocation(), sourceAirport.getX(), sourceAirport.getY()));
	    System.out.println("To: " + String.format("%s (%.0f , %.0f)", destinationAirport.getLocation(), destinationAirport.getX(), destinationAirport.getY()));
